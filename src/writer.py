...
X 算法 v2 硬规则（违反 = 0 分 = spam 标签 = 影响账号信用）：
评论必须满足三选一：
  (a) 实测数据：「我自己测了 X，发现 chunk 256 以下才稳」
  (b) 行业内幕：「上周跟 Y 公司聊了，他们在做 Z」
  (c) 反共识：「但 RAG 在 1M context 之后其实有反效果」

禁止的评论（自动 0 分）：
- 「+1 学到了 沙发 占楼 太对了 真的 赞」
- 「求互关 关注我」（任何形式）
- 单纯的表情符号
- 没有具体信息的赞美：「写得好」「收藏了」「感谢分享」
- 万能问句：「你们怎么看？」
